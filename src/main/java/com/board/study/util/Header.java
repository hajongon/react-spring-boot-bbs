...
public class Header<T> {
    ...
    private T data;
    // 페이지네이션 정보를 포함합니다. 예를 들어, API가 데이터 리스트를 반환할 때 페이지 번호, 페이지 크기, 총 페이지 수 등의 정보를 제공할 수 있습니다.
    ...
    // OK(T data, Pagination pagination): 성공 상태를 의미하며, 데이터와 페이지네이션 정보를 포함한 성공 응답을 생성합니다.
